...
import dejancv
import numpy as np
from dejancv.ColorModule import ColorFinder
...
while True:
    ...
    imgContours, conFound = dejancv.findContours(img, imgPre, minArea=20)
    ...
    # print(totalMoney)
    dejancv.putTextRect(imgCount, f'Rs.{totalMoney}', (100, 200),scale=10,offset=30,thickness=7)

    imgStacked = dejancv.stackImages([img, imgPre, imgContours,imgCount], 2, 1)
    dejancv.putTextRect(imgStacked, f'Rs.{totalMoney}', (50, 50))
